...
plt.savefig('./PC_eigens_Dixit_merge_xxxGuide.jpg', dpi=300)
plt.close()
...
plt.savefig('./PCA_Dixit_merge_xxxGuide.jpg', dpi=300)
plt.close()
#------------------------------------------------------------------------#
# t-SNE
...
plt.savefig('./tSNE_Dixit_merge_xxxGuide.jpg', dpi=300)
plt.close()
#------------------------------------------------------------------------#
# LASSO 
'''
...
plt.savefig('./PC_importance_Dixit_merge_xxxGuide.jpg', dpi=300)
plt.close()
PC_rank.to_csv('PC_importance_Dixit_merge_xxxGuide.csv')
#------------------------------------------------------------------------#
...
plot_pca['Guides'] = guides
sns.lmplot('PC1','PC2',data=plot_pca,hue='Guides',fit_reg=False, scatter_kws={'s':5})
plt.savefig('./PCA_new_Dixit_merge_xxxGuide.jpg', dpi=300)
plt.close()
#------------------------------------------------------------------------#
...
plot_tsne['Guides'] = guides
sns.lmplot('tSNE-1','tSNE-2',data=plot_tsne,hue='Guides',fit_reg=False, scatter_kws={'s':5})
plt.savefig('./tSNE_new_Dixit_merge_xxxGuide.jpg', dpi=300)
plt.close()
#------------------------------------------------------------------------#
# tSNE with important PCs
tsne_model = manifold.TSNE(n_components=2, perplexity=20, verbose=2,init='pca',n_iter_without_progress=10000,min_grad_norm=0)
...
plot_tsne['Guides'] = guides
sns.lmplot('tSNE-1','tSNE-2',data=plot_tsne,hue='Guides',fit_reg=False, scatter_kws={'s':5})
plt.savefig('./tSNE_PC1-4_removed_Dixit_merge_xxxGuide.jpg', dpi=300)
plt.close()
#------------------------------------------------------------------------#
